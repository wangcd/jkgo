...
<?php echo $this->fetch('library/category_tree.lbi'); ?>
  ...
  <div class="box">
   <div class="box_1">
    <h3><span>
    <?php if ($this->_var['lang']['advanced_search'] == "本月热销"): ?>
    今日特价
    <?php endif; ?>
    <?php echo $this->_var['lang']['advanced_search']; ?>
    </span></h3>
        ...
        <?php if ($this->_var['intromode'] == 'best'): ?>
         ...
         <?php endif; ?>
          ...
          <form action="search.php" method="post" class="sort" name="listform" id="form">
              ...
              <input type="image" name="imageField" src="themes/red_three/images/bnt_go.gif" alt="go"/>
...
?>
                ...
                <div>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" ><img src="themes/red_three/images/goumai.gif"></a>
    <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);"><img src="themes/red_three/images/shoucang.gif"></a> 
    </div>
             ...
             <?php elseif ($this->_var['pager']['display'] == 'grid'): ?>
              ...
              <div class="clearfix goodsBox cd_goodsBox">
                <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
                <?php if ($this->_var['goods']['goods_id']): ?>
                 <div class="goodsItem_search">
                       ...
                       <?php if ($this->_var['show_marketprice']): ?>
                        ...
                        <p style="text-align:center"><a href="<?php echo $this->_var['goods']['url']; ?>" title=""><img src="themes/red_three/images/qgm.jpg" /></a></p>
						<!-- 
                        <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" ><img src="themes/red_three/images/goumai.gif"></a> &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);"><img src="themes/red_three/images/shoucang.gif"></a> 
	-->
