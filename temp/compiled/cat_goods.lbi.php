...
?>
        ...
        <ul class="rs_iglr_ul">
        	<?php $_from = $this->_var['cat_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_01782900_1413962906');$this->_foreach['goods_foreach'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods_foreach']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_01782900_1413962906']):
        $this->_foreach['goods_foreach']['iteration']++;
?>
				<li>
					<div class="rs_iglr_img">
						<a href="<?php echo $this->_var['goods_0_01782900_1413962906']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods_0_01782900_1413962906']['thumb']; ?>" border="0" alt="<?php echo htmlspecialchars($this->_var['goods_0_01782900_1413962906']['name']); ?>" /></a>
					</div>
					<div class="rs_iglr_n">
						<a href="<?php echo $this->_var['goods_0_01782900_1413962906']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_01782900_1413962906']['name']); ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods_0_01782900_1413962906']['name']); ?></a>
					</div>
					<div class="rs_iglr_p">
                    <p style="float:left;">
						<span class="rs_pp">
							<?php if ($this->_var['goods_0_01782900_1413962906']['promote_price'] != ""): ?>
							<?php echo $this->_var['goods_0_01782900_1413962906']['promote_price']; ?>
							<?php else: ?>
							<?php echo $this->_var['goods_0_01782900_1413962906']['shop_price']; ?>
							<?php endif; ?>
						</span><br>
						<del><?php echo $this->_var['goods_0_01782900_1413962906']['market_price']; ?></del>
					</p>
                    	<a href="<?php echo $this->_var['goods_0_01782900_1413962906']['url']; ?>" style="float:right;" title="<?php echo htmlspecialchars($this->_var['goods_0_01782900_1413962906']['name']); ?>" target="_blank"><img src="themes/red_three/images/gwc.jpg" /></a>
					</div>
				</li>
			 <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
    ...
    <div class="cd_rqph">
    	<?php $_from = $this->_var['rs_idx_ads']['idx_step_right']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('adkey', 'ads');$this->_foreach['ads_foreach'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['ads_foreach']['total'] > 0):
    foreach ($_from AS $this->_var['adkey'] => $this->_var['ads']):
        $this->_foreach['ads_foreach']['iteration']++;
?>
