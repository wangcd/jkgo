...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/jquery-1.8.3.min.js,../js/jquery.json-2.4.min.js,../js/transport.js')); ?>
...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><!-- <img src="logo.jpg" alt="RockStore" /> --></div>
