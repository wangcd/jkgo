...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/utils.js,../js/jquery-1.8.3.min.js,../js/jquery.json-2.4.min.js,../js/global.js,../js/transport.js')); ?>
<script language="JavaScript">
<!--
